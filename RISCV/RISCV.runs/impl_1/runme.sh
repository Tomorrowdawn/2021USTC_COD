...
HD_PWD='D:/VerilogProject/RISCV/RISCV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPPCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopPPCPU.tcl -notrace
