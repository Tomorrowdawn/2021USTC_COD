...
HD_PWD='D:/VerilogProject/RISCV/RISCV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPPCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopPPCPU.tcl
